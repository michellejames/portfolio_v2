...
gulp.task("sass", function () {
	return gulp
		.src("./src/scss/**/*.scss") // run over these files
...
gulp.task("js", function () {
	...
	); // tell browsersync to send over the changes
});
